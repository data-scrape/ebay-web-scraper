...
[![GitHub stars](https://img.shields.io/github/stars/data-scrape/ebay-web-scraper?style=social)](https://github.com/data-scrape/ebay-web-scraper)
[![GitHub forks](https://img.shields.io/github/forks/data-scrape/ebay-web-scraper?style=social)](https://github.com/data-scrape/ebay-web-scraper/fork)
[![GitHub issues](https://img.shields.io/github/issues/data-scrape/ebay-web-scraper)](https://github.com/data-scrape/ebay-web-scraper/issues)
[![GitHub license](https://img.shields.io/github/license/data-scrape/ebay-web-scraper)](https://github.com/data-scrape/ebay-web-scraper/blob/main/LICENSE)
[![Python](https://img.shields.io/badge/Python-3.8+-blue?logo=python)](https://www.python.org/)

</div>


> eBay web scraper - extract product listings, prices, seller data


<!-- SEO keywords: ebay web scraper, Ebay Web Scraper, ebay web scraper python, ebay web scraper github -->
...
- Extract eBay product listings with full details
- Listing title, price, condition, seller info
- Product image URL extraction
- Shipping cost and delivery estimates
- Auction data: bids, time remaining, reserve price
- Seller rating and feedback score

## 🎯 Use Cases

Build product price databases, monitor eBay seller competition.
...
```bash
pip install git+https://github.com/data-scrape/ebay-web-scraper.git
```

### From source

```bash
git clone https://github.com/data-scrape/ebay-web-scraper.git
cd ebay-web-scraper
pip install -e .
```
...
```python
from ebay_web_scraper import Scraper
...
```bash
python ebay_web_scraper.py --query "your-query" --output results.json
```
...
### Is Ebay Web Scraper legal to use?
...
1. **⭐ Star this repository** — [Click here to star](https://github.com/data-scrape/ebay-web-scraper)
2. **📧 Share with your network** — Help others discover this tool
3. **🐛 Report issues** — [Open an issue](https://github.com/data-scrape/ebay-web-scraper/issues)
